<div class="sidebar sidebar-light sidebar-left bg-grey" data-perfect-scrollbar>
    ...
    <div class="sidebar-block p-0">
        ...
        <ul class="sidebar-menu mt-0">
            ...
            <li class="sidebar-menu-item {{ Route::currentRouteName() == 'admin.categories.index' ? 'active' : '' }}">
            ...
            <li class="sidebar-menu-item {{ Route::currentRouteName() == 'admin.products.index' 
            ...
            || Route::currentRouteName() == 'admin.variations.edit' ? 'active' : '' }}">
                <a class="sidebar-menu-button" href="{{ route('admin.products.index') }}">
                    <span class="sidebar-menu-icon sidebar-menu-icon--left">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
            ...
            <li class="sidebar-menu-item {{ Route::currentRouteName() == 'admin.orders.index' ? 'active' : '' }}">
                <a class="sidebar-menu-button" href="{{ route('admin.orders.index') }}">
                    <span class="sidebar-menu-icon sidebar-menu-icon--left">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
            ...
            <li class="sidebar-menu-item {{ Route::currentRouteName() == 'admin.stocks.index' ? 'active' : '' }}">
                <a class="sidebar-menu-button" href="{{ route('admin.stocks.index') }}">
                    <span class="sidebar-menu-icon sidebar-menu-icon--left">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="22" height="22">
                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
            ...
            <li class="sidebar-menu-item {{ Route::currentRouteName() == 'admin.files.index' ? 'active' : '' }}">
